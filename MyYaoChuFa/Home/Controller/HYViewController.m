...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context{
    ...
    _alpha = (_alpha <= 0)?0.00001:_alpha;
    ...
    [[[self.navigationController.navigationBar subviews] firstObject] setAlpha:_alpha];
}
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _navBarBackgroundImage = [self.navigationController.navigationBar backgroundImageForBarMetrics:UIBarMetricsDefault | UIBarMetricsDefaultPrompt];
//        _keyScrollView.contentOffset = CGPointMake(0, _keyScrollView.contentOffset.y + 64);
    });
    //设置背景图片
